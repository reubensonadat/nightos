            ...
            >
                ...
                <header className="relative z-10 mx-auto max-w-3xl flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Wifi indicator */}
                        <div className="flex h-9 w-9 items-center justify-center rounded-full border border-isabelline/15 bg-isabelline/5">
                            <WifiIcon className="h-4 w-4 text-isabelline/80" />
                        </div>
                        {/* Live status */}
