...
export function WaiterDashboardPromoSection() {
  ...
  const renderPerformanceMockup = () => {
    return (
      <div className="relative md:absolute md:inset-0 flex flex-col bg-[#e6e2d6] overflow-hidden no-scrollbar h-auto md:h-full">
        {/* Top Header */}
  ...
  const renderOrderEntryMockup = () => {
    return (
      <div className="relative md:absolute md:inset-0 bg-[#f4f3e8] font-sans text-licorice flex flex-col md:pb-6 pb-[14px] h-auto md:h-full">
        {/* Header */}
        ...
        {/* Content */}
        <div className="flex-1 px-5 pt-4 md:overflow-hidden overflow-visible no-scrollbar relative flex flex-col md:pb-24 pb-16">
            {/* Categories */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 relative">
          ...
          <div className="flex flex-col col-span-1 pb-24">
            ...
            <div ref={block2Ref} data-index="1" className="min-h-screen flex flex-col justify-center max-w-md mx-auto md:mx-0 py-12 md:py-0">
               ...
               <div className="md:hidden mt-10 relative w-full max-w-[320px] md:h-[580px] h-auto mx-auto bg-[#e6e2d6] rounded-[32px] overflow-hidden shadow-2xl border-[8px] border-[#e8e4d9]/50 ring-1 ring-white/50 shrink-0">
