        ...
        <div className="relative min-h-svh w-full bg-isabelline font-sans text-licorice antialiased">
            ...
            <header className="md:hidden sticky top-0 z-30 border-b border-licorice/8 bg-white/95 backdrop-blur-xl">
                <div className="flex items-center justify-between px-5 py-3">
                    ...
                    <div className="flex flex-col items-center leading-tight">
                        <span className="text-[10.5px] font-bold uppercase tracking-wider text-feldgrau truncate max-w-[180px]">
                            {displayVenueName}
                        </span>
                        <span className="text-[14px] font-bold tracking-tight text-licorice">{activeItem.label}</span>
                    </div>
                    <button
                        type="button"
                        onClick={() => setShowSignOutModal(true)}
            ...
            <div className="md:pl-64">
                ...
                <header className="hidden md:flex h-[60px] sticky top-0 z-30 items-center justify-between border-b border-licorice/8 bg-isabelline/95 backdrop-blur-xl px-8">
                    <div className="flex items-center gap-2.5">
                        <span className="text-[12px] font-bold uppercase tracking-wider text-feldgrau">
                            {displayVenueName}
                        </span>
                        <span className="text-feldgrau/30 font-light">/</span>
