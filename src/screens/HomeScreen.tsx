...
// Premium Unsplash hero ΓÇö warm, editorial cocktail imagery
const signatureImg =
...
/** Time-based greeting ΓÇö same pattern Campus Guide uses. */
...
export function HomeScreen({ onEnter, onStaffPortal, onKitchenDisplay, onManagerPortal }: Props) {
    ...
    // Live happy-hour countdown ΓÇö gives the page a "living" feel
    ...
    return (
        <main className="relative min-h-svh w-full overflow-x-hidden bg-isabelline font-sans text-licorice antialiased">
            ...
            <div
                ...
                "
            >
                {/* Ambient blur orbs ΓÇö Khaki warm + Light-Blue cool */}
                <div
                    aria-hidden="true"
                ...
                {/* ΓöÇΓöÇ Widget Strip (live data pills) ΓöÇΓöÇ */}
            ...
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
                OVERLAPPING CONTENT ΓÇö floats above the dark hero
              ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            <section className="relative z-20 -mt-12 px-5 md:px-8 pb-32 mx-auto max-w-3xl">
                {/* ΓöÇΓöÇ Featured Signature Card (the hero cocktail) ΓöÇΓöÇ */}
                <div
                    className="
                    ...
                    "
                >
                    {/* Image header ΓÇö clean, no ribbons */}
                    <div className="relative h-56 w-full overflow-hidden">
                        <img
                            src={signatureImg}
                            alt="Tonight's signature ΓÇö Hibiscus Spritz"
                ...
                {/* ΓöÇΓöÇ Figma Table Info & Call Staff Cards ΓöÇΓöÇ */}
                ...
                {staffCalled && (
                    <div className="mt-3 flex justify-center animate-velvet-rise">
                        <p className="text-[11px] font-semibold tracking-tight text-khaki bg-licorice/40 px-3 py-1 rounded-full backdrop-blur-sm">
                            Γ£ô Server has been notified ΓÇö Kojo is on the way to Table 04
                        </p>
                    </div>
                )}

                {/* ΓöÇΓöÇ Ambient strip ΓÇö editorial detail ΓöÇΓöÇ */}
                <div className="mt-4 flex items-center gap-3 rounded-2xl bg-white p-3 shadow-[0_4px_16px_rgba(35,20,12,0.04)] ring-1 ring-isabelline">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-0.5 text-[12px] font-semibold leading-tight tracking-tight text-licorice line-clamp-2">
                            "Tonight's bar is being led by Ama ΓÇö ask her about
                            the off-menu smoky Negroni."
                        </p>
                    </div>
                </div>

                {/* ΓöÇΓöÇ Staff & Operations entries ΓÇö discreet, for staff only ΓöÇΓöÇ */}
            ...
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
                STICKY BOTTOM CTA ΓÇö floats above everything
              ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            <div
                className={`
